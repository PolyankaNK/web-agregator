...
urlpatterns = [
    ...
    path("services/add/", views.add_service_submission, name="add_service_submission"),
    path("api/service-submissions/create/", views.create_service_submission, name="create_service_submission"),
